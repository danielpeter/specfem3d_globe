...
The 3D mantle model S20RTS (Ritsema, <span>Van Heijst</span>, and Woodhouse 1999) is superimposed onto the mantle mesh by the subroutine `model_s20rts.f90`. The call to this subroutine is of the form
